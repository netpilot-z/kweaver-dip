...
from app.cores.chat2plot.dataset_description import description
from app.cores.chat2plot.dictionary_helper import delete_null_field
from app.cores.chat2plot.prompt import (
    JSON_TAG,
    error_correction_prompt,
    explanation_prompt,
    system_prompt,
)
from app.cores.chat2plot.render import draw_altair, draw_plotly
from app.cores.chat2plot.schema import PlotConfig, ResponseType, get_schema_of_chart_config
...
def chat2plot(
    ...
    Args:
        ...
        chat: The chat instance for interaction with LLMs.
              If omitted, `ChatOpenAI(temperature=0.01, model_name="gpt-3.5-turbo-0613")` will be used.
        function_call:
...
def _get_or_default_chat_model(chat: BaseChatModel | None) -> BaseChatModel:
    if chat is None:
        return ChatOpenAI(temperature=0.01, model_name="gpt-3.5-turbo-0613")  # type: ignore
    return chat
